                ...
                <div class="col-sm-10 col-lg-5 col-xl-5 m-lr-auto m-b-50">
                    <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63  m-lr-0-xl p-lr-15-sm">
                        ...
                        <div class="flex-w flex-t bor12 p-b-13">
                            ...
                            <div class="container">
                            <div class="row">
                               <div class="col-md-12">Phương thức thanh toán</div><br><br>
                               <div class="col-md-12 row"><input name="pttt" value="Thanh toán khi nhận hàng" class="col-md-1 check" type="radio"><span class="col-md-10">Thanh toán khi nhận hàng (COD)</span> </div>
                               <div disabled="true"  class="col-md-12 row "><input name="pttt" disabled="true"  value="Thanh toán online" class="col-md-1 check" type="radio"><span class="col-md-10 " style="color: #c1c1c1;">Thanh toán online (chưa hỗ trợ)</span> </div>
                            </div>
                          </div>
                        </div>
