                ...
                <nav class="limiter-menu-desktop container">
                    ...
                    <div class="wrap-icon-header flex-w flex-r-m">
                        ...
                        @if(Session::has('customer_img') != null)
                             <img src="/upload/product/{{Session::get('customer_img')}}" width="40px" height="40px" style="border-radius: 50px;margin-right: 10px;" alt="">
                        @endif
                        <?php
    ...
    <div class="bg0 p-t-75 p-b-85">
        <div class="container">
            <div class="row" id="list_cart">
                                ...
                                <tr class="table_row">
                                    ...
                                    <td class="column-4">
                                        <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                            ...
                                            <input id="quanty-item-{{$item['productInfo']->id}}" class="mtext-104 cl3 txt-center num-product" type="number"
                                    ...
                                    <td class="column-5"><a href="javascript:"  class="btn " onclick="deleteListItem({{$item['productInfo']->id}})"><i class="fa fa-times"></i></a>
                                                         <a href="javascript:" onclick="upDateCart({{$item['productInfo']->id}})" class="btn "><i class="fa fa-save"></i></a></td>
                                </tr>
                ...
                <div class="col-sm-10 col-lg-12 col-xl-5 m-lr-auto m-b-50">
                    <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63  m-lr-0-xl p-lr-15-sm">
                        ...
                        <div class="flex-w flex-t bor12 p-b-13">
                            ...
                            <div class="container">
                            <div class="row">
                                @if(Session::has('customer_email') != null)
                                <input name="shipping_email" value="{{Session::get('customer_email')}}" type="email" class="col-md-12" placeholder="nhập email" style="border: 1px solid black;margin-bottom: 30px;border-radius: 10px;padding: 5px;" >
                                @endif
                                @if(Session::has('customer_name') != null)
                                <input value="{{Session::get('customer_name')}}" name="shipping_name" type="text" class="col-md-12" placeholder="Tên người nhận" style="border: 1px solid black;margin-bottom: 30px;border-radius: 10px;padding:5px;" >
                                @endif
                                <input name="shipping_address" type="text" class="col-md-12" placeholder="Địa chỉ người nhận" style="border: 1px solid black;margin-bottom: 30px;border-radius: 10px;padding: 5px;" >
                                @if(Session::has('customer_phone') != null)
                                <input value="{{Session::get('customer_phone')}}" name="shipping_phone" type="text" class="col-md-12" placeholder="Số điện thoại người nhận" style="border: 1px solid black;margin-bottom: 30px;border-radius: 10px;padding: 5px;" >
                                @endif
                            </div>
                          </div>
                        </div>
                       ...
                       <div class="row">
                        <button type="submit" name="save_checkout" class="col-md-12 btn bg-dark text-white" >GỬI</button>
    ...
    $('.btn-num-product-up').on('click', function(){
        ...
        function upDateCart(id){
            ...
            $.ajax({
                ...
                renderListCart(response);
                alertify.message('Cập nhật giỏ hàng thành công');
            });
        }
