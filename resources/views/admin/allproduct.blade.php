          ...
          <div class="d-none d-md-block">
            <form class="position-relative">
              ...
              <div
                ...
                <input type="search" class="js-form-search form-control" placeholder="Nhập tên sản phẩm"
            ...
            <ul class="navbar-nav navbar-nav-lg nav-tabs">
              ...
              <li class="navbar-vertical-aside-has-menu show">
                ...
                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <li class="nav-item">
                    <a class="nav-link " href="/admin" title="Default">
              ...
              <li class="navbar-vertical-aside-has-menu ">
                ...
                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  ...
                  <li class="navbar-vertical-aside-has-menu ">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                      <li class="nav-item">
                        <a class="nav-link active" href="/admin/product" title="Profile">
                          <span class="tio-circle-outlined nav-indicator-icon"></span>
      ...
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Trang sản phẩm</h1>
          </div>

          <div class="col-sm-auto">
            <a class="btn btn-secondary" href="/admin/product/add-product" >
          ...
          <div class="row justify-content-between align-items-center flex-grow-1">
            <div class="col-12 col-md">
              <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-header-title">Tất cả sản phẩm</h5>
              ...
              <div class="row align-items-sm-center">
                ...
                <form action="" class="" method="get">
                    ...
                    <div class="input-group input-group-merge input-group-flush">
                      ...
                      <select  class="form-control" name="fill_cat">
                        <option value="">---chọn danh mục---</option>
                        <a href="/admin/product"><option value="">Tất cả sản phẩm</option></a>
                        @foreach($category as $cat)
                        <option value="{{$cat->id_cat}}?name={{$cat->name_cat}}">{{$cat->name_cat}}</option>
                        @endforeach
                      </select>
                ...
                <div class="col-md">
                  <form action="" method="get">
                    ...
                    <div class="input-group input-group-merge input-group-flush">
                      ...
                      <input  type="search" class="form-control" name="key" placeholder="Tìm kiếm"
                        aria-label="tìm kiếm">
          ...
          <table id="datatable"
            ...
            <tr>
                ...
                <td class="table-column-pl-0">
                  <a class="media align-items-center" href=""data-toggle="modal" data-target="#exampleModalLong{{$pd->id}}">
                    <!-- <div class="avatar avatar-sm avatar-circle mr-2">
                      <img class="avatar-img" src="assets\img\160x160\img10.jpg" alt="Image Description">
                    </div> -->
                    <div class="media-body">
                      <span class="h5 text-hover-primary mb-0">{{$pd -> product_name}}<i class="tio-verified text-primary"
                          data-toggle="tooltip" data-placement="top" title="Top endorsed"></i></span>
                    </div>
                  </a>
                </td>
                <td>
                  <span class="legend-indicator bg-success"></span>{{number_format($pd->product_price). ' VND'}}
                </td>
                <td><img src="/upload/product/{{$pd->product_image}}" alt="" width="80px" height="100px"></td>
                <td class="text-center">@if ($pd->status ==0) 
                   <span style="  width: 50px;" class=""><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-eye-slash-fill text-danger" viewBox="0 0 16 16">
                                                                          <path d="m10.79 12.912-1.614-1.615a3.5 3.5 0 0 1-4.474-4.474l-2.06-2.06C.938 6.278 0 8 0 8s3 5.5 8 5.5a7.029 7.029 0 0 0 2.79-.588zM5.21 3.088A7.028 7.028 0 0 1 8 2.5c5 0 8 5.5 8 5.5s-.939 1.721-2.641 3.238l-2.062-2.062a3.5 3.5 0 0 0-4.474-4.474L5.21 3.089z"/>
                                                                          <path d="M5.525 7.646a2.5 2.5 0 0 0 2.829 2.829l-2.83-2.829zm4.95.708-2.829-2.83a2.5 2.5 0 0 1 2.829 2.829zm3.171 6-12-12 .708-.708 12 12-.708.708z"/>
                                                                          </svg></span>
                @else
                   <span style="  width: 50px;" class=""><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-eye-fill text-primary" viewBox="0 0 16 16">
                ...
                <td class="text-right"><div class="btn-group">
                                        <a data-toggle="modal" data-target="#exampleModalLong{{$pd->id}}" href="javascript:void(0)"  title="" class="btn btn-xs btn-secondary" data-original-title="Details"><i class="fa fa-info-circle"></i></a>
                                        <a href="/admin/product/edit-product/{{$pd->id}}" data-toggle="tooltip" title="" class="btn btn-xs btn-primary" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
                                        <a href="" data-toggle="modal" data-target="#exampleModal{{$pd->id}}" class="btn btn-xs btn-danger" data-original-title="Delete"><i class="fa fa-times"></i></a>
                                    </div></td>
                        <!-- Modal -->
                                    <div class="modal fade" id="exampleModalLong{{$pd->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="card mb-3">
                                            <img class="card-img-top" src="/upload/product/{{$pd->product_image}}" alt="Card image cap" width="150px" height="400px">
                                            <div class="card-body">
                                              <h5 class="card-title">{{$pd -> product_name}}</h5>
                                              <p class="card-text">{!! $pd->product_content !!}This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                          
                                              <div class="row">
                                                <div class="col-md-4">
                                                <p class="">    Có giá:<span class="text-danger"> {{number_format($pd->product_price). ' VND'}}</span> </p>
                                                </div>
                                                <div class="col-md-4">
                                                  trạng thái: @if ($pd->status ==0) 
                                                            <span style="  width: 50px;" class="badge badge-danger">ẨN</span>
                                                          @else
                                                            <span style="  width: 50px;" class="badge badge-primary">HIỆN</span>
                                                          @endif
                                                </div>
                                                <div class="col-md-4">
                                                  Thuộc loại: <span  class="badge badge-secondary">{{$pd->name_cat}}</span>
                                                </div>
                                              </div>
                                              Hành động: <div class="btn-group">
                                                    
                                                    <a href="/admin/product/edit-product/{{$pd->id}}" data-toggle="tooltip" title="" class="btn btn-xs btn-primary" data-original-title="Edit">u<i class="fa fa-pencil"></i></a>
                                                    <a href="javascript:void(0)" data-toggle="tooltip" title="" class="btn btn-xs btn-danger" data-original-title="Delete">x</a>
                                                </div>
                                            </div>
                                          </div>
                                          </div>
                                    ...
                                    <div class="modal fade" id="exampleModal{{$pd->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content text-center">
                                          
                                          <div class="modal-body">
                                           <h3> <b class="text-danger"><i>{{$pd->product_name}}</i></b> sẽ bị xóa khỏi hệ thống, bạn có chắc chứ?</h3>
                                          </div>
                                          <div class="modal-footer">
                                            <button type="button" class="btn btn-danger" data-dismiss="modal">Hủy</button>
                                            <a href="/delete-product/{{$pd->id}}"><button type="button" class="btn btn-secondaly" >Vẫn xóa</button></a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
              ...
              <div class="step-content">
                ...
                <ul class="list-group list-group-sm">
                  <li class="list-group-item list-group-item-light">
                    <div class="row gx-1">
                      <div class="col">
                        <img class="img-fluid rounded ie-sidebar-activity-img" src="/assets/svgi/llustrations/card-1.svg"
                          alt="Image Description">
                      </div>
                      <div class="col">
