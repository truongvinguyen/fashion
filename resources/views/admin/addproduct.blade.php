                ...
                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  ...
                  <li class="navbar-vertical-aside-has-menu ">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="/admin/product/add-product" title="Teams">
                          <span class="tio-circle-outlined nav-indicator-icon"></span>
  ...
  <main id="content" role="main" class="main pointer-event">
    ...
    <div class="content container-fluid">
      ...
      <div class="card-body">
                    ...
                    <form method="post" action="/admin/product/save-product" enctype="multipart/form-data">
                     @csrf
                     <div class="row">
                           ...
                           <div class="col-md-9">
                                    <div class="form-row">
                                      ...
                                      <div class="value">
                                          <input class="input--style-6" type="text" name="name_product">
                                          @error('name_product')
                                  ...
                                  <div class="form-row">
                                      ...
                                      <div class="value">
                                          <div class="input-group">
                                              <input class="input--style-6" type="text" name="price_product" placeholder="">
                                              @error('price_product')
                                              <div class="text-danger">{{ $message }}</div>
                                              @enderror
                                          </div>
                            ...
                            <div class="value">
                                <div class="input-group">
                                              ...
                                              <div class="text-danger">{{ $message }}</div>
                                              @enderror
                                    <textarea class="textarea--style-6" name="content_product" placeholder="Message sent to the employer"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                ...
                                <div class="form-check">
                                      <input class="form-check-input" type="radio" name="status_product" id="flexRadioDefault1" value="1">
                                      <label class="form-check-label" for="flexRadioDefault1">
                                       Hiện
                                      </label>
                                    </div>
                                    <div class="form-check">
                                      <input class="form-check-input" type="radio" name="status_product" id="flexRadioDefault2" value="0" >
                        ...
                        <div class="form-row">
                            ...
                            @enderror
                                <div class="input-group js-input-file">
                                    <input class="" type="file" name="img_product" id="file">
                        ...
                        <div>
                            <button class="btn btn-primary" type="submit" name="save_product" >Thêm sản phẩm</button>
                        </div>
                      </div>
                    </form>
                </div>
