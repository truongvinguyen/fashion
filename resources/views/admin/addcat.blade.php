                ...
                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <li class="navbar-vertical-aside-has-menu ">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="#" title="Leaderboard">
                          <span class="tio-circle-outlined nav-indicator-icon"></span>
  ...
  <main id="content" role="main" class="main pointer-event">
    ...
    <div class="content container-fluid">
      ...
      <div class="card-body">
                    ...
                    <form method="post" action="/admin/category/save-category" enctype="multipart/form-data">
                     @csrf
                     <div class="row">
                           ...
                           <div class="col-md-9">
                                    <div class="form-row">
                                      ...
                                      <div class="value">
                                          <input class="input--style-6" type="text" name="name_category">
                                      </div>
                                  </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group js-input-file">
                                    <input class="" type="file" name="img_category" id="file">
                        ...
                        <div>
                            <button class="btn btn-primary" type="submit" name="save_product" >Thêm danh mục</button>
                        </div>
                      </div>
                    </form>
                </div>
