  ...
  <main id="content" role="main" class="main pointer-event">
    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Chỉnh sửa sản phẩm</h1>
          </div>
      ...
      <div class="card-body">
                    ...
                    <form method="post" action="/admin/product/edit-product-save/{{$product->id}}" enctype="multipart/form-data">
                     @csrf
                      <div class="row">
                      <div class="col-md-9">
                          <div class="form-row">
                                ...
                                <div class="value">
                                    <input class="input--style-6" type="text" name="name_product" value="{{$product->product_name}}">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">giá sản phẩm</div>
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-6" type="text" name="price_product" placeholder="" value="{{$product->product_price}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <textarea class="textarea--style-6" name="content_product" placeholder="Message sent to the employer">{{$product->product_content}}</textarea>
                                    </div>
                                </div>
                            </div>
                      </div>
                      ...
                      <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <select name="cat_product" id="">
                                    @foreach($all_cat as $cat)
                                        <option  value="{{$cat->id_cat}}"   {{($cat->id_cat==$product->id_category)?'selected':''}}>           
                                        {{$cat->name_cat}}
                                        </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-row">
                            <div class="name">Trạng thái sản phẩm</div>
                            <div class="value">
                                <div class="input-group">
                                    
                                    <div class="form-check">
                                      <input class="form-check-input" type="radio" name="status_product" id="flexRadioDefault1" value="1" {{($product->status==1)?'checked ':''}}>
                                      <label class="form-check-label" for="flexRadioDefault1">
                                       Hiện
                                      </label>
                                    </div>
                                    <div class="form-check">
                                      <input class="form-check-input" type="radio" name="status_product" id="flexRadioDefault2" value="0" {{($product->status==0)?'checked ':''}}>
                        ...
                        <div class="form-row">
                            <div class="name">Upload hình ảnh</div>
                            <div class="value">
                            <img src="/upload/product/{{$product->product_image}}" width="150px" height="130px" alt="">
                                <div class="input-group js-input-file">
                                
                                    <input class="input-file" type="file" name="img_product" id="file">
                                    <label class="label--file" for="file">Choose file</label>
                                    <span class="input-file__info"> </span>
                                   
                                </div>
                                <div class="label--desc">Chọn hình ảnh sản phẩm</div>
                            </div>
                        </div>
                      </div>
                      </div>
                        ...
                        <div>
                            <button class="btn btn-primary" type="submit" name="save_product" >Lưu sản phẩm</button>
                        </div>
