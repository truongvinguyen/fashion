              ...
              <li class="navbar-vertical-aside-has-menu ">
                ...
                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <li class="navbar-vertical-aside-has-menu ">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                      <li class="nav-item">
                        <a  class="nav-link active" href="/admin/category" title="Overview">
      ...
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title">Trang quản lý danh mục</h1>
          </div>

          <div class="col-sm-auto">
            <a class="btn btn-primary" href="/admin/category/add-category" >
            ...
            <tr>
                ...
                <td class="table-column-pl-0">
                  <a class="media align-items-center" href="user-profile.html">
                    ...
                    <div class="media-body">
                      <span class="h5 text-hover-primary mb-0">{{$pd->name_cat}}<i class="tio-verified text-primary"
                          data-toggle="tooltip" data-placement="top" title="Top endorsed"></i></span>
                    </div>
                  </a>
                </td>
                <td>{{$pd->id_cat}}</td>
                <td class="text-center"><img src="/upload/category/{{$pd->cat_image}}" alt="" width="80px" height="100px"></td>
                
                <td class="text-right"><div class="btn-group">
                                        <a data-toggle="modal" data-target="#exampleModalLong{{$pd->id}}" href="javascript:void(0)"  title="" class="btn btn-xs btn-info" data-original-title="Details">i<i class="fa fa-info-circle"></i></a>
                                        <a href="/admin/product/edit-product/{{$pd->id}}" data-toggle="tooltip" title="" class="btn btn-xs btn-success" data-original-title="Edit">u<i class="fa fa-pencil"></i></a>
                                        <a href="" data-toggle="modal" data-target="#exampleModal{{$pd->id}}" class="btn btn-xs btn-danger" data-original-title="Delete">x</a>
                                    </div></td>
                        <!-- Modal -->
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                  trạng thái: @if ($pd->status ==0) 
                                                          ...
                                                          @else
                                                            <span style="  width: 50px;" class="badge badge-success">HIỆN</span>
                                                          @endif
                                                </div>
                                                <div class="col-md-4">
                                                  Thuộc loại: <span  class="badge badge-success">{{$pd->name_cat}}</span>
                                                </div>
                                              </div>
