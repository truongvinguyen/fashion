...
<body class="animsition">
    ...
    <div class="container" style="margin-bottom: 70px;">
        ...
        <h5 class="text-center">Để dễ dàng theo dõi đơn hàng của bạn</h5>
        <div class="row">
            <div class="col-md-6">
                <h4 class="text-center">Đăng nhập ngay</h4>
                <form action="/login-account" method="post">
                    ...
                    <div class="form-floating mb-3">
                        <input name="email_account" class="form-control" id="" type="email" placeholder="nhập email"
                            data-sb-validations="required,email" />
                        <label for="emailAddress">Địa chỉ emal</label>

                    </div>
                    <div class="form-floating mb-3">
                        <input name="password_account" class="form-control" id="" type="password"
                            placeholder="nhập mật khẩu" data-sb-validations="required,email" />
                        <label for="emailAddress">Mật khẩu</label>

                    </div>
                    <div class="d-grid">
                        <button name="login" style="background-color: black;color: white;" class="btn btn-lg disabled"
                            id="submitButton" type="submit">Đăng nhập</button>
                    </div>
                </form>
            </div>
            <div class="col-md-6">
                <h4 class="text-center">Đăng ký</h4>
                <form id="contactForm" action="/add-customer" method="post" enctype="multipart/form-data">
                    @csrf
                    <!-- Name Input -->
                    <div class="form-floating mb-3">
                        <input name="customer_name" class="form-control" id="name" type="text" placeholder="Name"
                    ...
                    <!-- Email Input -->
                    <div class="form-floating mb-3">
                        <input name="customer_email" class="form-control" id="" type="email" placeholder="nhập email"
                            data-sb-validations="required,email" />
                        <label for="emailAddress">Địa chỉ emal</label>

                    </div>
                    <div class="form-floating mb-3">
                        <input name="customer_password" class="form-control" id="" type="password"
                            placeholder="nhập mật khẩu" data-sb-validations="required,email" />
                        <label for="emailAddress">Mật khẩu</label>
                    ...
                    <!-- Message Input -->
                    <div class="form-floating mb-3">
                        <input name="customer_phone" class="form-control" id="" type="text"
                            placeholder="nhập số điện thoại" data-sb-validations="required,email" />
                        <label for="emailAddress">Điện thoại</label>

                    </div>
                    <div class="form-floating mb-3">
                        <input name="customer_img" class="form-control" id="" type="file"
                            placeholder="nhập số điện thoại" data-sb-validations="required,email" />
                        <label for="emailAddress">Hình ảnh</label>
                    ...
                    <!-- Submit button -->
                    <div class="d-grid">
                        <button name="submit" style="background-color: black;color: white;" class="btn btn-lg disabled"
                            id="submitButton" type="submit">Đăng ký</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        alertify.warning('{{Session::get('success')}}');
    </script>
    {{Session::get('success')}}
    @endif -->
    <!-- Back to top -->
